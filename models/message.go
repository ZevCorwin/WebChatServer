...
type MessageStatusStage int32

const (
	StatusStageSending  MessageStatusStage = 0
	StatusStageSent     MessageStatusStage = 1
	StatusStageReceived MessageStatusStage = 2
	StatusStageSeen     MessageStatusStage = 3
)
...
type Message struct {
	...
	StatusStage      MessageStatusStage   `bson:"statusStage" json:"statusStage"`
	...
	DeliveryReceipts []DeliveryReceipt    `bson:"deliveryReceipts,omitempty" json:"deliveryReceipts,omitempty"`
